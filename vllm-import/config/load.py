...
class LoadConfig:
    ...
    - "dynamic_expert" will load model weights lazily, moving expert weights
      to pinned CPU memory and using an EagerExpertCache to manage GPU
      residency with optional predictor-driven prefetching.
