...
static void ggml_cuda_mul_mat_id(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    if(0) fprintf(stderr, "dyn-ex mul_mat_id entry: ne02=%lld\n", (long long)dst->src[0]->ne[2]);
